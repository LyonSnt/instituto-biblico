                ...
                <form method="post" action="{{ url('/login') }}">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" value="{{ old('email') }}"
                            placeholder="@lang('auth.login.field.email')"
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" placeholder="@lang('auth.login.field.password')"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="submit"
                                class="btn btn-primary btn-block">@lang('auth.login.button.submit')</button>
                        </div>
