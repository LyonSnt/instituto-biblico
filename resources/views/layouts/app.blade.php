...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="{{url('images/lo2.png')}}" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="{{url('images/lo2.png')}}" class="img-circle elevation-2" alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022 <a href="#">Instituto Bíblico</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    ...
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script> {{-- puesto por mi el 21-04-2022..21:30 --}}
    <!--
