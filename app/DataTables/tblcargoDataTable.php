...
class tblcargoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'tblcargos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\tblcargo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(tblcargo $model)
    {
    ...
    {
        return 'tblcargos_datatable_' . time();
    }
}
